...
There is no browser CORS path to GX10. Production deployment must reject a public or loopback `ELOVA_BACKEND_URL`; local development may use loopback only under an explicit development environment.
