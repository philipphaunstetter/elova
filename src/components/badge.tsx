...
const colors = {
  ...
  blue: 'bg-rose-500/15 text-rose-700 group-data-hover:bg-rose-500/25 dark:text-rose-400 dark:group-data-hover:bg-rose-500/25',
  indigo:
    'bg-rose-500/15 text-rose-700 group-data-hover:bg-rose-500/25 dark:text-rose-400 dark:group-data-hover:bg-rose-500/20',
  violet:
...
export const BadgeButton = forwardRef(function BadgeButton(
  ...
  let classes = clsx(
    className,
    'group relative inline-flex rounded-md focus:not-data-focus:outline-hidden data-focus:outline-2 data-focus:outline-offset-2 data-focus:outline-rose-500'
  )
